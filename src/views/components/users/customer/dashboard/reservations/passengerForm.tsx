    ...
    return (
        <form onSubmit={handleSubmit}>
            <div className="space-y-6">
                <Label className="text-lg md:text-xl font-bold text-gray-800 dark:text-white mb-6">
                            ...
                            <Card className="border-0 shadow-none bg-white dark:bg-gray-800 p-4 pb-6">
                                <CardContent className="flex flex-col gap-4 p-0">
                                    ...
                                    <div className="flex border-b mb-4">
                                        <button
                                            ...
                                            className={`cursor-pointer px-4 py-2 font-medium text-sm border-b-2 ${
                                                ...
                                                isTabComplete(passenger, 'basic')
                                                    ? 'after:content-["✓"] after:text-green-500 after:ml-1'
                                                    : ''
                                            }`}
                                        ...
                                        <button
                                            ...
                                            className={`cursor-pointer px-4 py-2 font-medium text-sm border-b-2 ${
                                                ...
                                                isTabComplete(passenger, 'travel')
                                                    ? 'after:content-["✓"] after:text-green-500 after:ml-1'
                                                    : ''
                                            }`}
                                        ...
                                        <button
                                            ...
                                            onClick={() =>
                                                togglePassengerTab(pIndex, 'preferences')
                                            }
                                        >
                                            <span className="flex items-center gap-1 text-sm">
                                                <Briefcase size={20} />
                                    ...
                                    {passenger.activeTab === 'basic' && (
                                        ...
                                        >
                                            <div className="grid grid-cols-1 gap-4">
                                                ...
                                                <div className={'flex flex-col gap-2'}>
                                                    <Label htmlFor={`firstName-${pIndex}`}>
                                                        First Name
                                            ...
                                            <div className={'flex flex-col gap-2'}>
                                                <Label htmlFor={`dateOfBirth-${pIndex}`}>
                                                    Date of Birth
                                                    <span className="text-red-500">*</span>
                                                </Label>
                                                <Input
                                    ...
                                    {passenger.activeTab === 'travel' && (
                                        ...
                                        >
                                            <div className={'flex flex-col gap-2'}>
                                                <Label htmlFor={`nationality-${pIndex}`}>
                                                    Nationality
                                                    <span className="text-red-500">*</span>
                                                </Label>
                                                <Select
                                            ...
                                            <div className="grid grid-cols-2 gap-4">
                                                <div className={'flex flex-col gap-2'}>
                                                    <Label htmlFor={`passportId-${pIndex}`}>
                                                        Passport ID
                                                        <span className="text-red-500">*</span>
                                                    </Label>
                                                    <Input
                                                ...
                                                <div className={'flex flex-col gap-2'}>
                                                    <Label htmlFor={`passportExpiryDate-${pIndex}`}>
                                                        Expiry Date
                                                        <span className="text-red-500">*</span>
                                                    </Label>
                                                    <Input
                                    ...
                                    {passenger.activeTab === 'preferences' && (
                                        ...
                                        >
                                            <div className={'flex flex-col gap-2'}>
                                                <Label htmlFor={`mealPreference-${pIndex}`}>
                                                    Meal Preference
                                                </Label>
                                                <Select
                                            ...
                                            <div className="flex items-center space-x-2">
                                                ...
                                                >
                                                    Special assistance required (wheelchair,
                                                    mobility assistance)
                                                </Label>
                                            </div>
                                            ...
                                            {passenger.specialAssistance && (
                                                <div className="mt-4 bg-amber-50 dark:bg-amber-900/20 p-4 rounded-lg">
                                                    <p className="text-sm text-amber-700 dark:text-amber-300">
                                                        An airline representative will contact you
                                                        before your flight to arrange special
                                                        assistance.
                                                    </p>
                                                </div>
                                            )}
