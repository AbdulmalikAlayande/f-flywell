            ...
            <div className="Profile-Part-Two">
                ...
                <div className={'User-Profile-Main-Body'}>
                    ...
                    <div className={'Profile-Image-Frame'}>
                        <Icon className={"profile-icon"} icon={'gg:profile'} height={'48vh'} width={'60vh'} color={'powderblue'}/>
                        <ButtonWithIcon onClick={openPopUp} icon={'iconamoon:edit-thin'} iconHeight={'30px'} iconWidth={'30px'} buttonPlaceHolder={''} iconColor='white'/>
                    </div>
