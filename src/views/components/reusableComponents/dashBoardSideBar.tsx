...
const DashBoardSideBar = () => {
    ...
    function navigateToDashBoard(event: React.MouseEvent<HTMLButtonElement, MouseEvent>): void {
    ...
    return (
        <div className='Dashbaord-Side-Bar-Main-Frame'>
            ...
            <div className="Middle-Part">
                <ButtonWithIcon value={'dashboard'} onClick={(event)=>navigateToDashBoard(event)} icon={'pixelarticons:dashbaord'} buttonPlaceHolder={'Dashboard'} iconHeight={'25px'} iconWidth={'25px'}/>
