...
const SignUp = () => {
    ...
    function handleInputChange(event: React.ChangeEvent<HTMLInputElement>): void {
        ...
        setUserData((previousValue)=>({...previousValue, [eventTarget.name]: eventTarget.value}))
    ...
    function postDataToBackend(data: LoginData | SignUpData, postUrl?: string | URL, params?: AxiosRequestConfig): any {
        ...
        <div className={"SignUp-Main-Frame"}>
            <form onSubmit={handleSubmit} className={'SignUp-Form'}>
                <div className='SignUp-Form-Inputs-Frame'>
                    <AuthInput name={'firstName'} inputType={'text'} inputPlaceHolder={'john'} inputLabel={'First Name'} onChange={handleInputChange} required/>
                    <AuthInput name={'lastName'} inputType={'text'} inputPlaceHolder={'doe'} inputLabel={'Last Name'} onChange={handleInputChange} required/>
                    <AuthInput name={'email'} inputType={'email'} inputPlaceHolder={'johndoe@gmail.com'} inputLabel={'Email'} onChange={handleInputChange} required/>
                    <AuthInput name={'password'} inputType={'password'} inputPlaceHolder={'********'} inputLabel={'Password'} onChange={handleInputChange} required/>
                    <AuthInput name={'phoneNumber'} inputType={'tel'} inputPlaceHolder={'+2347036174617'} inputLabel={'Phone Number'} onChange={handleInputChange} required/>
                </div>
