...
class Logger {
    ...
    static info(message: string): void {
        console.log(
        `${chalk.bgBlue.black.bold(' INFO  ')} ${chalk.gray(this.getTimestamp())} - ${chalk.blue(
            message
        )}`
        );
    }
    ...
    static warning(message: string): void {
        console.log(
        `${chalk.bgYellow.black.bold(' WARN  ')} ${chalk.gray(this.getTimestamp())} - ${chalk.yellow(
            message
        )}`
        );
    }
    ...
    static success(message: string): void {
        console.log(
        `${chalk.bgGreen.black.bold(' SUCCESS ')} ${chalk.gray(this.getTimestamp())} - ${chalk.green(
            message
        )}`
        );
    }
